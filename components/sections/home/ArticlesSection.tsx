...
export default function ArticlesSection() {
  ...
  useEffect(() => {
    ...
    if (!hasShownSwipeDemo.current && typeof window !== 'undefined') {
      const demoShown = sessionStorage.getItem('articlesSwipeDemoShown');
      if (!demoShown) {
        setTimeout(() => {
          showSwipeDemo();
          hasShownSwipeDemo.current = true;
          sessionStorage.setItem('articlesSwipeDemoShown', 'true');
      ...
      <div className="videos-section">
        <div className="videos-container">
          <div className="videos-header">
                    <h2 className="videos-title">Latest Articles</h2>
              ...
              return (
                <div key={article.id} className="video-card">
                  <div className="video-media">
                    <Link href={`/article/${article.id}`} onClick={handleCardClick}>
                            <Image
                  ...
                  <div className="video-content">
                    <h3 className="video-title">
                      <Link href={`/article/${article.id}`} onClick={handleCardClick}>{article.title}</Link>
                    </h3>
                  </div>
                </div>
              );
